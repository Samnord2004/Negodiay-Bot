        ...
        <div className="relative z-10 flex flex-col md:flex-row items-start md:items-center justify-between gap-6">
          <div className="space-y-2">
            ...
            <p className="text-xs sm:text-sm font-bold text-amber-950 max-w-2xl leading-relaxed">
              Официальная история и зал славы команды: как зарождалась банда, рождение легендарного логотипа, громкие спортивные победы и летопись наших главных соратников с возможностью пополнения фото и видео архивов.
            </p>
          </div>
