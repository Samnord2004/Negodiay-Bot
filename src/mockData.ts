...
export const initialMessages: ChatMessage[] = [
  {
    ...
    text: "Здорово, банда Негодяев! Я на связи. Чат команды готов к общению, походным байкам и координации слёта!",
    timestamp: "12:00",
    isBot: true
  }
];
...
export const initialBotConfig: BotConfig = {
  ...
  welcomeTemplate: "Привет, Негодяи! Я ваш ИИ-помощник Максимка. Спрашивайте у меня про наши туры, сплавы, походы, долги или просто поболтаем по душам!",
  foundingYear: 1993
};
...
<svg xmlns="http://www.w3.org/2000/svg" width="600" height="400" viewBox="0 0 600 400" style="background:#f0fdf4; font-family:sans-serif;">
  ...
  <g transform="translate(40, 80)">
    ...
    <text x="115" y="45" fill="#64748b" font-size="11">Главный судья: Судейская коллегия слёта. Главная поляна лагеря.</text>
...
export const initialPhotos: GalleryPhoto[] = [
  {
    ...
    cloudUrl: "https://disk.yandex.ru/d/negodyai_2026_full",
    itemType: "photo",
    uploadedBy: "Андрей Самойлов (Ковбой)",
    uploadedAt: "2026-08-15",
    likes: 18,
    likedUserIds: ["cowboy_1"]
  },
  {
    id: "photo_cloud_2025",
    year: 2025,
    title: "Большой архив слёта 2025: Водный поход и песни у костра (Яндекс Диск)",
    description: "Полная подборка оригинальных фотографий и видеороликов высокого разрешения (более 850 кадров) на Яндекс Диске команды.",
    cloudUrl: "https://disk.yandex.ru/d/negodyai_slet_2025_archive",
    itemType: "cloud_album",
    uploadedBy: "Андрей Самойлов (Ковбой)",
  ...
  },
  {
    id: "photo_cloud_2024",
    year: 2024,
    title: "Архив на Яндекс Диске: Традиционный слёт на р. Киржач 2024",
    description: "Все походные снимки, полоса препятствий, награждение победителей и вечерний концерт у костра.",
    cloudUrl: "https://disk.yandex.ru/d/negodyai_kirzhach_2024",
    itemType: "cloud_album",
    uploadedBy: "Андрей Самойлов (Ковбой)",
  ...
  },
  {
    ...
    description: "Костровая атмосфера, гитара и любимые походные песни до утра.",
  ...
  },
  {
    id: "photo_cloud_2018",
    year: 2018,
    title: "Архив на Яндекс Диске: 25 лет команде Негодяи (Слёт 2018)",
    description: "Юбилейный слёт братства, презентация герба команды, колуны Fiskars, штурмовой лагерь.",
    cloudUrl: "https://disk.yandex.ru/d/negodyai_25let_2018_archive",
    itemType: "cloud_album",
    uploadedBy: "Андрей Самойлов (Ковбой)",
    uploadedAt: "2018-07-12",
    likes: 56,
    likedUserIds: ["cowboy_1"]
  },
  {
    id: "photo_cloud_2008",
    year: 2008,
    title: "Архив на Яндекс Диске: 15-летие Негодяев (Поход на байдарках 2008)",
    description: "Оцифрованные фотопленки и видеозаписи водного похода, преодоление завалов и стоянки на песчаных косах.",
    cloudUrl: "https://disk.yandex.ru/d/negodyai_15let_2008_archive",
    itemType: "cloud_album",
    uploadedBy: "Андрей Самойлов (Ковбой)",
    uploadedAt: "2008-08-20",
    likes: 38,
    likedUserIds: ["cowboy_1"]
  },
  {
    id: "photo_cloud_1993",
    year: 1993,
    title: "Архив на Яндекс Диске: Золотой фонд 1993 — Первый слёт команды Негодяи",
    description: "Исторические отсканированные снимки первого палаточного лагеря мая 1993 года. Брезентовые палатки, закопчённый армейский казан и рождение имени команды под проливным дождём.",
    cloudUrl: "https://disk.yandex.ru/d/negodyai_1993_founding_archive",
    itemType: "cloud_album",
    uploadedBy: "Андрей Самойлов (Ковбой)",
    uploadedAt: "1993-05-15",
    likes: 64,
    likedUserIds: ["cowboy_1"]
  }
];
...
export const INITIAL_STORIES: any[] = [
  ...
  },
  {
    ...
    content: `Каждый Негодяй уникален, но подвиги наших соратников навсегда вписаны золотыми буквами в историю братства:\n\n🔥 Капитан Ковбой (Андрей Самойлов) — бессменный предводитель, стоявший у истоков команды в 1993 году. Организатор всех маршрутов, хранитель огня и традиций братства.\n\n🍲 Главный Казан команды — повар высшего разряда. Во время штормового ливня на озере удержал шатер и одновременно приготовил 45 порций сочного плова в 30-литровом казане.\n\n🌲 Костровой дозор — за 20 минут в темноте заготовил сухой валежник на всю ночь для лагеря, используя один только колун и ручную цепную пилу.\n\n💼 Негодяйская казна — железный порядок в учете общих сборов фонда и смет, где каждый рубль идет на общее благо и походное снаряжение!`,
    photos: [
